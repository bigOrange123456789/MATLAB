function [node_xyz, face_node ]= obj_read( input_file_name )
...
function [ node_xyz, face_order, face_node, normal_vector, vertex_normal ] = obj_read ( input_file_name, node_num, face_num, normal_num, order_max )
...
function [ node_num, face_num, normal_num, order_max ] = obj_size (  input_file_name )
